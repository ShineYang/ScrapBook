 ...
 */
package com.shineyang.pullword_lib.view;
 ...
 */
public class PullWordLayout extends ViewGroup implements BigBangActionBar.ActionListener, NestedScrollingChild {
    ...
    public PullWordLayout(Context context) {
        super(context);
    }

    public PullWordLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PullWordLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        readAttribute(attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public PullWordLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void addTextItem(String text) {
        ...
        view.setTextColor(ContextCompat.getColorStateList(getContext(), R.color.pullword_item_text));
