...
public class FloatingView implements View.OnClickListener, View.OnTouchListener, ViewContainer.KeyEventHandler {
    ...
    public FloatingView(Context application, CharSequence content) {
